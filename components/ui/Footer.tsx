import { env } from "@staticweb/utils/global";
import type { NavLinkItem } from "./Navbar";

export default function Footer({sentence, links}: {sentence: string, links: NavLinkItem[]}) {
        ...
        <div class="mx-auto max-w-4xl text-center px-4"> 
            ...
            <ul class="flex flex-wrap justify-center items-center mb-6 text-gray-500 text-sm">
                {links.map(({label, path}) => <li>
                    <a href={path} class="mr-4 hover:underline md:mr-6 hover:text-gray-600">{label}</a>
                </li>)}
            </ul>
